...
for _ in range(tc):
    ...
    longest_run_0 = max(map(len, s.split('1')))
    ans0 = onenum + 2 * (zeronum - longest_run_0)
    longest_run_1 = max(map(len, s.split('0')))
    ans1 = zeronum + 2 * (onenum - longest_run_1)
    print(s)

    print(longest_run_0, longest_run_1)
    print(min(ans0, ans1))